...
* The original package name 'com.verticurl.jenkins.spring-jenkins-project' is invalid and this project uses 'com.verticurl.jenkins.springjenkinsproject' instead.
